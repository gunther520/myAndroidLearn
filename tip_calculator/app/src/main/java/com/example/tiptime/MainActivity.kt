...
fun TipTimeLayout() {
    ...
    val numTip=tip.toDoubleOrNull() ?: 0.0
    val roundUp= if (roundUpInput){ceil(numTip)} else numTip
    val roundText=NumberFormat.getCurrencyInstance().format(roundUp)
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.tip_amount, roundText),
